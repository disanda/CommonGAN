...
# -----output_dir
if args.experiment_name == 'none': args.experiment_name = '%s_%s' % (args.dataset, args.adversarial_loss_mode)
...
# --------dataset
data_loader, shape = data.make_dataset(args.dataset, args.batch_size, args.img_size, pin_memory = True)
...
print(G)
D = net.Discriminator_SpectrualNorm(args.z_dim, input_channels = args.img_channels, image_size=args.img_size, Dscale=args.Dscale, Gscale=args.Gscale).to(device)
print(D)
